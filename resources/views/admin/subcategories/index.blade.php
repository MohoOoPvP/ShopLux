...
<div class="card">
    <div class="card-header">
        <h2><i class="fas fa-layer-group"></i> All Subcategories</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><strong>{{ $sub->name }}</strong><br><small style="color:#999">{{ $sub->slug }}</small></td>
            ...
            @empty
            <tr><td colspan="4" style="text-align:center;padding:2rem;color:#999">No subcategories. <a href="{{ route('admin.subcategories.create') }}">Add one!</a></td></tr>
            @endforelse
        </tbody>
    </table>
