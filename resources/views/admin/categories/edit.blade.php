    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @error('name')<small style="color:#e94560">{{ $message }}</small>@enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Image</label>
                @if($category->image)
                    <div style="margin-bottom:.5rem"><img src="{{ asset('storage/' . $category->image) }}" style="width:80px;height:80px;object-fit:cover;border-radius:8px"></div>
                @endif
