        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    @else
                        <div style="width:48px;height:48px;background:#f0f0f0;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#aaa"><i class="fas fa-image"></i></div>
                    @endif
                </td>
            ...
            @empty
            <tr><td colspan="6" style="text-align:center;padding:2rem;color:#999">No categories found. <a href="{{ route('admin.categories.create') }}">Add one!</a></td></tr>
            @endforelse
        </tbody>
    </table>
